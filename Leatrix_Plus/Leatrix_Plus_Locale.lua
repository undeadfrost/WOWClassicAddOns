...
L["If checked, spell IDs will be shown in buff icon tooltips located in the buff frame and under the target frame."] = "Si coché, les ID des sorts seront affichés dans les infobulles des icônes de buff situées dans le cadre du buff et sous le cadre cible."
...
L["If checked, the skill trainer frame will be larger."] = "Si coché, le cadre du maître sera plus grand."
...
L["If checked, the vendor price will be shown in item tooltips."] = "Si coché, le prix marchand sera affiché dans les infobulles des objets."
L["If checked, the zone text bar will be hidden.  The tracking button tooltip will show zone information."] = "Si coché, la barre de texte de la zone sera masquée. L'infobulle du bouton de suivi affiche des informations sur la zone."
...
L["If checked, tooltips for world units will be hidden during combat.|n|nYou can hold the shift key down to override this setting."] = "Si coché, les infobulles des unités mondiales seront masquées pendant le combat.|n|nVous pouvez maintenir la touche Maj enfoncée pour remplacer ce paramètre."
...
L["If checked, you will be able to reposition the tooltip."] = "Si coché, vous pourrez repositionner l'infobulle."
...
L["Quest completed."] = "Missão sucessa."
L["Quest not completed."] = "Missão não sucessa."
