...
L["If checked, your character will automatically stand or dismount when an action is prevented because you are either seated or mounted."] = "Si cette option est cochée, votre personnage se lèvera ou se démontera automatiquement lorsqu'une action est empêchée parce que vous êtes assis ou monté."
...
L["Spooky"] = "Effrayant"
L["Stand and dismount"] = "Se lever et démonter"
