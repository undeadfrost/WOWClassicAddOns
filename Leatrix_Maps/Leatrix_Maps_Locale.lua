...
L["If checked, dungeons and raids will be shown."] = "Si está marcado, se mostrarán calabozos y bandas."
...
L["If checked, zone, dungeon and fishing skill levels will be shown."] = "Si está marcado, se mostrarán los niveles de zona, calabozo y habilidad de pesca."
...
L["Hillsbrad Foothills"] = "Laderas de Trabalomas"
L["Icons"] = "Iconos"
L["If checked, boat harbors, zeppelin towers and tram stations will be shown."] = "Si está marcado, se mostrarán los puertos de los barcos, las torres de los zepelines y las estaciones de tren."
L["If checked, coordinates will be shown."] = "Si está marcado, se mostrarán las coordenadas."
...
L["Astranaar"] = "Astranaar"
L["Auberdine"] = "Auberdine"
L["Auto change zones"] = "Changer automatiquement les zones"
L["Azshara"] = "Azshara"
...
L["Class colored icons"] = "Icônes colorées de classe"
L["Classic"] = "Classique"
...
L["Enlarge player arrow"] = "Agrandir la flèche du joueur"
L["Enter"] = "Entrer"
...
L["Hide town and city icons"] = "Masquer les icônes de la ville et de la cité"
L["Hillsbrad Foothills"] = "Contreforts d'Hillsbrad"
L["Icons"] = "Icônes"
L["If checked, boat harbors, zeppelin towers and tram stations will be shown."] = "Si coché, les ports pour bateaux, les tours zeppelin et les stations de tram seront affichés."
L["If checked, coordinates will be shown."] = "Si coché, les coordonnées seront affichées."
L["If checked, dungeons and raids will be shown."] = "Si coché, les donjons et les raids seront affichés."
L["If checked, flight points will be shown."] = "Si coché, les points de vol seront affichés."
L["If checked, group icons will use a modern, class-colored design."] = "Si coché, les icônes de groupe utiliseront un design moderne de couleur de classe."
L["If checked, opening the map will use the same zoom level from when you last closed it as long as the map zone has not changed."] = "Si coché, l'ouverture de la carte utilisera le même niveau de zoom que lors de sa dernière fermeture tant que la zone de la carte n'a pas changé."
L["If checked, pointing at the map while your character is moving will cause the stationary opacity setting to be applied."] = "Si coché, le fait de pointer la carte pendant le déplacement de votre personnage entraînera l'application du paramètre d'opacité stationnaire."
L["If checked, points of interest will be shown."] = "Si coché, les points d'intérêt seront affichés."
L["If checked, the default fullscreen map will be used.|n|nNote that enabling this option will lock out some of the other options."] = "Si coché, la carte plein écran par défaut sera utilisée.|n|nNotez que l'activation de cette option bloquera certaines des autres options."
L["If checked, the map border will be removed."] = "Si coché, la bordure de la carte sera supprimée."
L["If checked, the map frame will remain open until you close it."] = "Si coché, le cadre de la carte restera ouvert jusqu'à ce que vous le fermiez."
L["If checked, the minimap button will be shown."] = "Si coché, le bouton de la mini-carte sera affiché."
L["If checked, the minimum fishing skill levels will be shown."] = "Si coché, les niveaux de compétence de pêche minimum seront affichés."
L["If checked, town and city icons will not be shown on the continent maps."] = "Si coché, les icônes de ville et de cité ne seront pas affichées sur les cartes du continent."
L["If checked, unexplored areas of the map will be shown."] = "Si coché, les zones inexplorées de la carte seront affichées."
L["If checked, unexplored areas will be tinted."] = "Si coché, les zones inexplorées seront teintées."
L["If checked, when your character changes zones, the map will automatically change to the new zone."] = "Si coché, lorsque votre personnage change de zone, la carte passe automatiquement à la nouvelle zone."
L["If checked, you will be able to enlarge the player arrow."] = "Si coché, vous pourrez agrandir la flèche du joueur."
L["If checked, you will be able to scale and move the map.|n|nScale the map by dragging the scale handle in the bottom-right corner.|n|nMove the map by dragging the border and frame edges.  If you have removed the map border, a drag button will be shown in the top-left corner."] = "Si coché, vous pourrez redimensionner et déplacer la carte.|n|nMettez la carte à l'échelle en traîner la poignée d'échelle dans le coin inférieur droit.|n|nDéplacez la carte en traîner la bordure et les bords du cadre. Si vous avez supprimé la bordure de la carte, un bouton de glisser apparaîtra dans le coin supérieur gauche."
L["If checked, you will be able to set the opacity of the map."] = "Si coché, vous pourrez définir l'opacité de la carte."
L["If checked, zone, dungeon and fishing skill levels will be shown."] = "Si coché, les niveaux de compétence de zone, de donjon et de pêche seront affichés."
...
L["Reload"] = "Recharger"
L["Remember zoom level"] = "N'oubliez pas le niveau de zoom"
L["Remove map border"] = "Supprimer la bordure de la carte"
...
L["Set map opacity"] = "Définir l'opacité de la carte"
...
L["Show points of interest"] = "Afficher les points d'intérêt"
...
L["Sticky map frame"] = "Cadre de carte collante"
L["Stonard"] = "Stonard"
...
L["The Forgotten Coast"] = "Côte oubliée"
...
L["Astranaar"] = "Astranaar"
L["Auberdine"] = "Auberdine"
L["Auto change zones"] = "Alterar zonas automaticamente"
L["Azshara"] = "Azshara"
...
L["Class colored icons"] = "Ícones coloridos de classe"
L["Classic"] = "Clássico"
...
L["Enlarge player arrow"] = "Aumentar flecha do jogador"
L["Enter"] = "Entrar"
...
L["Hide town and city icons"] = "Ocultar ícones de vila e cidade"
...
L["Reload"] = "Recarregar"
L["Remember zoom level"] = "Lembre-se do nível de zoom"
...
L["Set map opacity"] = "Definir opacidade do mapa"
...
L["Show points of interest"] = "Mostrar pontos de interesse"
L["Show scale handle"] = "Mostrar alça de escala"
L["Show unexplored areas"] = "Mostrar áreas inexploradas"
L["Show zone levels"] = "Mostrar níveis da zona"
L["Silithus"] = "Silithus"
...
L["Sticky map frame"] = "Quadro de mapa pegajoso"
L["Stonard"] = "Pedregal"
...
L["The Forgotten Coast"] = "A Costa Esquecida"
...
L["Unlock map frame"] = "Desbloquear quadro de mapa"
L["Upper Blackrock Spire"] = "Pico da Rocha Negra Superior"
L["Use default map"] = "Usar mapa predefinição"
